 ...
 */
-- SELECT 
-- 	COUNT(product_quantity) as product_quantity_count,
...
-- LEFT JOIN orders_table as orders 
-- 	ON products.product_code = orders.product_code
-- LEFT JOIN dim_store_details as stores
...
-- LEFT JOIN orders_table as orders 
-- 	ON products.product_code = orders.product_code
-- LEFT JOIN dim_date_times as times 
-- 	ON orders.date_uuid = times.date_uuid
-- GROUP BY year,month
-- ORDER BY total_sales DESC;
/*
